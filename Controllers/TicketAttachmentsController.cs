...
namespace JATS.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Created,UserId,TicketId,Description,FileName,Data,FileContentType")] TicketAttachment ticketAttachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Created,UserId,TicketId,Description,FileName,Data,FileContentType")] TicketAttachment ticketAttachment)
        {
