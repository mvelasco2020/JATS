...
namespace JATS.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,TicketId,Created,RecipientId,Viewed,SenderId")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,TicketId,Created,RecipientId,Viewed,SenderId")] Notification notification)
        {
