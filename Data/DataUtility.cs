...
namespace JATS.Data
{
    ...
    public static class DataUtility
    {
        ...
        public static async Task ManageDataAsync(IHost host)
        {
            ...
            var userManagerSvc = svcProvider.GetRequiredService<UserManager<JTUser>>();
        ...
        public static async Task SeedDefaultProjectPriorityAsync(ApplicationDbContext context)
        {
            try
            {
                IList<Models.ProjectPriority> projectPriorities = new List<ProjectPriority>() {
                                                    new ProjectPriority() { Name = ProjectPriorityEnum.Low.ToString() },
                                                    new ProjectPriority() { Name = ProjectPriorityEnum.Medium.ToString() },
                                                    new ProjectPriority() { Name = ProjectPriorityEnum.High.ToString() },
                                                    new ProjectPriority() { Name = ProjectPriorityEnum.Urgent.ToString() },
                };
        ...
        public static async Task SeedDefautProjectsAsync(ApplicationDbContext context)
        {
            ...
            int priorityLow = context.ProjectPriorities.FirstOrDefault(p => p.Name == ProjectPriorityEnum.Low.ToString()).Id;
            int priorityMedium = context.ProjectPriorities.FirstOrDefault(p => p.Name == ProjectPriorityEnum.Medium.ToString()).Id;
            int priorityHigh = context.ProjectPriorities.FirstOrDefault(p => p.Name == ProjectPriorityEnum.High.ToString()).Id;
            int priorityUrgent = context.ProjectPriorities.FirstOrDefault(p => p.Name == ProjectPriorityEnum.Urgent.ToString()).Id;
        ...
        public static async Task SeedDefaultUsersAsync(UserManager<JTUser> userManager)
        {
            //Seed Default Admin User
            var defaultUser = new JTUser
            {
            ...
            //Seed Default Tech User
            defaultUser = new JTUser
            {
                UserName = "Technician1@bugtracker.com",
                Email = "Technician1@bugtracker.com",
                FirstName = "Elon",
                LastName = "Appuser",
                EmailConfirmed = true,
                CompanyId = company1Id
            ...
            {
                Console.WriteLine("*************  ERROR  *************");
                Console.WriteLine("Error Seeding Default Technician1 User.");
                Console.WriteLine(ex.Message);
                Console.WriteLine("***********************************");
                throw;
            }
            ...
            //Seed Default tech2 User
            defaultUser = new JTUser
            {
                UserName = "Technician2@bugtracker.com",
                Email = "Technician2@bugtracker.com",
                FirstName = "James",
                LastName = "Appuser",
                EmailConfirmed = true,
                CompanyId = company2Id
            ...
            {
                Console.WriteLine("*************  ERROR  *************");
                Console.WriteLine("Error Seeding Default Technician2 User.");
                Console.WriteLine(ex.Message);
                Console.WriteLine("***********************************");
                throw;
            }
            ...
            //Seed Default Tech3 User
            defaultUser = new JTUser
            {
                UserName = "Technician3@bugtracker.com",
                Email = "Technician3@bugtracker.com",
                FirstName = "Natasha",
                LastName = "Appuser",
                EmailConfirmed = true,
                CompanyId = company1Id
            ...
            {
                Console.WriteLine("*************  ERROR  *************");
                Console.WriteLine("Error Seeding Default Technician3 User.");
                Console.WriteLine(ex.Message);
                Console.WriteLine("***********************************");
                throw;
            }
            ...
            //Seed Default tech4 User
            defaultUser = new JTUser
            {
                UserName = "Technician4@bugtracker.com",
                Email = "Technician4@bugtracker.com",
                FirstName = "Carol",
                LastName = "Appuser",
                EmailConfirmed = true,
                CompanyId = company2Id
            ...
            {
                Console.WriteLine("*************  ERROR  *************");
                Console.WriteLine("Error Seeding Default Technician4 User.");
                Console.WriteLine(ex.Message);
                Console.WriteLine("***********************************");
                throw;
            }
            ...
            //Seed Default Technician5 User
            defaultUser = new JTUser
            {
                UserName = "Technician5@bugtracker.com",
                Email = "Technician5@bugtracker.com",
                FirstName = "Tony",
                LastName = "Appuser",
                EmailConfirmed = true,
                CompanyId = company1Id
            ...
            {
                Console.WriteLine("*************  ERROR  *************");
                Console.WriteLine("Error Seeding Default Technician5 User.");
                Console.WriteLine(ex.Message);
                Console.WriteLine("***********************************");
                throw;
            }

            //Seed Default Technician6 User
            defaultUser = new JTUser
            {
                UserName = "Technician6@bugtracker.com",
                Email = "Technician6@bugtracker.com",
                FirstName = "Bruce",
                LastName = "Appuser",
                EmailConfirmed = true,
                CompanyId = company2Id
        ...
        public static async Task SeedDemoUsersAsync(UserManager<JTUser> userManager)
        {
            ...
            {
                Console.WriteLine("*************  ERROR  *************");
                Console.WriteLine("Error Seeding Demo Technician1 User.");
                Console.WriteLine(ex.Message);
                Console.WriteLine("***********************************");
                throw;
            }
        ...
        public static async Task SeedDefaultTicketStatusAsync(ApplicationDbContext context)
        {
            try
            {
                IList<TicketStatus> ticketStatuses = new List<TicketStatus>() {
                    ...
                    new TicketStatus() { Name = TicketStatusEnum.InProgress.ToString() },         // Ticket is assigned and currently being worked 
                    new TicketStatus() { Name = TicketStatusEnum.Testing.ToString()  },            // Ticket is assigned and is currently being tested
                    new TicketStatus() { Name = TicketStatusEnum.Resolved.ToString()  },           // Ticket remains assigned to the Technician but work in now complete
                };
        ...
        public static async Task SeedDefautTicketsAsync(ApplicationDbContext context)
        {
            ...
            int priorityLow = context.TicketPriorities.FirstOrDefault(p => p.Name == TicketPriorityEnum.Low.ToString()).Id;
            int priorityMedium = context.TicketPriorities.FirstOrDefault(p => p.Name == TicketPriorityEnum.Medium.ToString()).Id;
            int priorityHigh = context.TicketPriorities.FirstOrDefault(p => p.Name == TicketPriorityEnum.High.ToString()).Id;
            int priorityUrgent = context.TicketPriorities.FirstOrDefault(p => p.Name == TicketPriorityEnum.Urgent.ToString()).Id;

            //Get ticket status Ids
            int statusNew = context.TicketStatuses.FirstOrDefault(p => p.Name == TicketStatusEnum.New.ToString()).Id;
            int statusDev = context.TicketStatuses.FirstOrDefault(p => p.Name == TicketStatusEnum.InProgress.ToString()).Id;
